(function () {
    ...
    var MapKit = function () {
        this.options = {
            ...
            lat: 49.281468,
            lon: -123.104446,
            buttonCallback: "mapKit.onMapCallback"
        };
    ...
    MapKit.prototype = {
        ...
        onMapCallback: function(passedId) {
            // TODO this hack is goto-niveau
            localStorage.diditId = passedId;
            console.log("diditid from ls : " + localStorage.diditId);
            mapKit.hideMap();
            $(window).attr("location","../views/DiditDetail.html");
